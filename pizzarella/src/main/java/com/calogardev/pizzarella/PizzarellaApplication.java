...
public class PizzarellaApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		roleManager.setPrivileges(Arrays.asList(canManageOrders, canManageUsers));
		...
		createUser(new UserDto("Adrián", "Porras González", "12346978E", "adrian", "123456", Arrays.asList(roleEmpty)));
		createUser(new UserDto("Sara", "Rodríguez Vega", "42347569W", "sara", "123456", Arrays.asList(roleEmpty)));
